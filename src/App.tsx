  ...
  return (
    <>
      <main className="bg-[#f3f7f7] px-5 py-10 sm:px-10 md:px-16 lg:px-40">
        ...
        <section>
          <div className="w-full bg-[#e4ecec] rounded-lg ">
            <div className="w-full rounded-lg relative overflow-hidden mb-10 md:w-2/3 md:mx-auto">
              <img
                src="https://a0.muscache.com/im/pictures/prohost-api/Hosting-17355559/original/9b28aa75-2404-4e76-bd24-f6d80486d03a.jpeg"
                alt=""
                className="w-full h-full object-cover"
        ...
        <section className="flex justify-center items-center flex-wrap gap-3 my-10 sm:gap-5">
        ...
        <section className="my-16">
          <div className="grid grid-flow-row-dense  justify-center items-center gap-5 px-10 sm:grid-cols-2 ">
        ...
        <section className="my-10">
          <div className="mb-10">
            <p className="text-xl font-bold text-center text-primary-500 mb-2 md:text-2xl md:mb-5 lg:text-3xl">
              About
            </p>
            <p className="text-center md:w-2/3 md:mx-auto">
